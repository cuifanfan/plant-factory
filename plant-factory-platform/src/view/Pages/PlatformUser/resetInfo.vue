    ...
    <v-card-text class="">
      <v-row class="ma-0">
        ...
        <div style="width: 500px">
          <v-text-field label="用户名" outlined dense v-model="myinfo.nickname"></v-text-field>
          <v-text-field label="手机号码" outlined dense v-model="myinfo.phone" disabled></v-text-field>
          <v-text-field label="创建时间" outlined dense v-model="myinfo.createTime" disabled></v-text-field>
          <v-text-field label="状态" outlined dense :value="myinfo.status === 0 ? '禁用' : '正常'" disabled></v-text-field>
