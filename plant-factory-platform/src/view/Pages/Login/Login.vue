            ...
            <v-col lg="6" class="right white rounded-lg pa-0 pt-8 pb-5">
              <v-col cols="10" offset="1">
                ...
                <v-form ref="form" v-model="valid" lazy-validation>
                  <v-text-field v-model="username" :counter="20" :rules="usernameRules" label="手机号" required></v-text-field>
                  ...
                  <v-checkbox v-model="checkbox" label="记住账号密码" required :style="{ display: 'inline-block' }"></v-checkbox>
                  <a href="javascript:;" class="grey--text float-right pt-5" @click="$router.push('/findpassword')"> 忘记密码 </a>
                  <v-btn
                    class="mr-4 black"
                    @click="validate"
                    :text="true"
...
<script>
import { platformLogin } from "@/api/authentication";
