          ...
          <v-row class="py-5 px-7 pb-0" align="center">
            <my-search v-model="showSearch">
              <template slot="header">
                <v-text-field placeholder="设备所有者电话" label="设备所有者电话" style="max-width: 200px" dense outlined :rules="[rules.number]" v-model="searchForm.owner"></v-text-field>
                <v-text-field placeholder="设备的mac地址" outlined label="设备的mac地址" style="max-width: 200px" :rules="[rules.mac]" dense class="ml-3" v-model="searchForm.mac"></v-text-field>
                <!-- <v-icon>mdi-menu-down</v-icon> -->

                <v-btn text class="light-blue align-self-start darken-1 ml-auto" color="white" depressed min-width="100" @click="searchDevice()"> 搜索 </v-btn>
              ...
              <v-list class="pa-0 mt-1">
                ...
                <v-list-item class="pa-0 mt-1" style="height: 60px">
                  <v-text-field placeholder="设备型号" outlined label="设备型号" style="max-width: 200px" dense v-model="searchForm.model"></v-text-field>
                </v-list-item>
              </v-list>
            </my-search>
          </v-row>
