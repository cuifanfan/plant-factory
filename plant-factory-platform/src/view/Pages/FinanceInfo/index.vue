        ...
        <v-row class="py-5 px-7 pb-0" align="center">
          <my-search v-model="showSearch">
            <template slot="header">
              <v-text-field placeholder="订单号" outlined style="max-width: 200px" dense v-model="searchItem.source"> </v-text-field>
              <v-text-field placeholder="收益类别" outlined style="max-width: 200px" dense class="ml-3" v-model="searchItem.type"> </v-text-field>
              <v-btn text class="light-blue darken-1 align-self-start ml-auto" color="white" depressed min-width="100" @click="searchInfo"> 搜索 </v-btn>
